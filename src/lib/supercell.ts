...
/** The player's last 25 battles, newest first. */
export function fetchBattleLog(tag: string): Promise<BattleLog> {
  return scFetch<BattleLog>(`/players/%23${normalizePlayerTag(tag)}/battlelog`);
}
