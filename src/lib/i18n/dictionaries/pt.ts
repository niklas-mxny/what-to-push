...
const pt: Record<DictionaryKey, string> = {
  ...
  "settings.password.description": "Depois disso, os outros dispositivos conectados à sua conta serão desconectados.",
  "settings.password.current": "Senha atual",
  "settings.password.new": "Nova senha",
  "settings.password.repeat": "Repita a nova senha",
  "settings.password.submit": "Alterar senha",
  "settings.password.success": "Senha alterada — os outros dispositivos foram desconectados.",
  "settings.password.mismatch": "As novas senhas não coincidem.",
  "settings.password.show": "Mostrar senhas",
  "settings.password.hide": "Ocultar senhas",
  ...
  "errors.wrong_password": "A senha atual está incorreta.",
  ...
  "trophyActivity.title": "Atividade de troféus",
  "trophyActivity.rangeLabel": "Período",
  "trophyActivity.period.1d": "últimas 24 horas",
  "trophyActivity.period.1w": "últimos 7 dias",
  "trophyActivity.period.1m": "últimos 30 dias",
  "trophyActivity.period.1y": "últimos 12 meses",
  "trophyActivity.trophiesIn": "troféus · {period}",
  "trophyActivity.empty": "Ainda não há variações de troféus registradas neste período.",
  "trophyActivity.error": "Não foi possível carregar o histórico de troféus.",
  "trophyActivity.ahead": "Você ganhou {count} troféus a mais ({period}).",
  "trophyActivity.behind": "Você ganhou {count} troféus a menos ({period}).",
  "trophyActivity.tied": "Vocês ganharam exatamente a mesma quantidade de troféus ({period}).",
  "trophyActivity.loginToCompare": "Entre para comparar seus próprios ganhos de troféus.",
  "trophyActivity.noOwnTag": "Vincule sua tag de jogador para comparar seus ganhos de troféus.",
  "trophyActivity.since": "Registrado desde {date} — a Supercell não fornece histórico mais antigo.",
