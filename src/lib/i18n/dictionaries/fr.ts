...
const fr: Record<DictionaryKey, string> = {
  ...
  "settings.password.description": "Les autres appareils connectés à votre compte seront ensuite déconnectés.",
  "settings.password.current": "Mot de passe actuel",
  "settings.password.new": "Nouveau mot de passe",
  "settings.password.repeat": "Répétez le nouveau mot de passe",
  "settings.password.submit": "Changer le mot de passe",
  "settings.password.success": "Mot de passe changé — les autres appareils ont été déconnectés.",
  "settings.password.mismatch": "Les nouveaux mots de passe ne correspondent pas.",
  "settings.password.show": "Afficher les mots de passe",
  "settings.password.hide": "Masquer les mots de passe",
  ...
  "errors.wrong_password": "Le mot de passe actuel est incorrect.",
  ...
  "trophyActivity.title": "Activité des trophées",
  "trophyActivity.rangeLabel": "Période",
  "trophyActivity.period.1d": "les dernières 24 heures",
  "trophyActivity.period.1w": "les 7 derniers jours",
  "trophyActivity.period.1m": "les 30 derniers jours",
  "trophyActivity.period.1y": "les 12 derniers mois",
  "trophyActivity.trophiesIn": "trophées sur {period}",
  "trophyActivity.empty": "Aucune variation de trophées enregistrée sur cette période pour l'instant.",
  "trophyActivity.error": "Impossible de charger l'historique des trophées.",
  "trophyActivity.ahead": "Vous avez gagné {count} trophées de plus sur {period}.",
  "trophyActivity.behind": "Vous avez gagné {count} trophées de moins sur {period}.",
  "trophyActivity.tied": "Vous avez gagné exactement autant de trophées sur {period}.",
  "trophyActivity.loginToCompare": "Connectez-vous pour comparer vos propres gains de trophées.",
  "trophyActivity.noOwnTag": "Associez votre tag de joueur pour comparer vos gains de trophées.",
  "trophyActivity.since": "Enregistré depuis le {date} — Supercell ne fournit pas d'historique plus ancien.",
