...
const es: Record<DictionaryKey, string> = {
  ...
  "slot.open": "{mode} · {map}: mapa y builds",
  "slot.build": "Build",
  "slot.allDetails": "Todos los detalles",
  "slot.options": "Opciones de brawler",
  "slot.top": "Top",
  ...
  "settings.tag.account": "Se guarda en tu cuenta @{username}: se carga automáticamente siempre que inicies sesión.",
  "settings.password.title": "Cambiar contraseña",
  "settings.password.description": "Después se cerrará la sesión en los demás dispositivos conectados a tu cuenta.",
  "settings.password.current": "Contraseña actual",
  "settings.password.new": "Nueva contraseña",
  "settings.password.repeat": "Repite la nueva contraseña",
  "settings.password.submit": "Cambiar contraseña",
  "settings.password.success": "Contraseña cambiada: se cerró la sesión en los demás dispositivos.",
  ...
  "brawler.details": "Detalles: {name}",
  "brawler.close": "Cerrar",
  "brawler.power": "Poder {power}/{max}",
  "brawler.gadgets": "Gadgets",
  "brawler.starPowers": "Poderes estelares",
  "brawler.gears": "Engranajes",
  "brawler.unlocked": "Desbloqueado",
  "brawler.locked": "Bloqueado",
  "brawler.noGears": "Aún no hay engranajes desbloqueados.",
  "brawler.noHypercharge": "Aún no hay hipercarga.",
  "brawler.goalProgress": "Progreso del objetivo",
  "brawler.nextPrestige": "Siguiente: Prestigio {n}",
  "brawler.maxPrestige": "Prestigio máximo alcanzado",
  "brawler.goalReached": "¡Objetivo alcanzado!",
  "brawler.remaining": "Faltan {count} trofeos",
  "brawler.prestige": "Prestigio {n}",
  "brawler.highest": "Máximo: {trophies}",
  ...
  "errors.wrong_password": "La contraseña actual es incorrecta.",
  ...
  "trophyActivity.title": "Actividad de trofeos",
  "trophyActivity.rangeLabel": "Periodo",
  "trophyActivity.period.1d": "las últimas 24 horas",
  "trophyActivity.period.1w": "los últimos 7 días",
  "trophyActivity.period.1m": "los últimos 30 días",
  "trophyActivity.period.1y": "los últimos 12 meses",
  "trophyActivity.trophiesIn": "trofeos en {period}",
  "trophyActivity.empty": "Aún no hay cambios de trofeos registrados en este periodo.",
  "trophyActivity.error": "No se pudo cargar el historial de trofeos.",
  "trophyActivity.ahead": "Ganaste {count} trofeos más en {period}.",
  "trophyActivity.behind": "Ganaste {count} trofeos menos en {period}.",
  "trophyActivity.tied": "Ganasteis exactamente los mismos trofeos en {period}.",
  "trophyActivity.loginToCompare": "Inicia sesión para comparar tus propios trofeos ganados.",
  "trophyActivity.noOwnTag": "Vincula tu tag de jugador para comparar tus trofeos ganados.",
  "trophyActivity.since": "Registrado desde el {date}: Supercell no ofrece historial más antiguo.",
